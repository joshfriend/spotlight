...
import com.fueledbycaffeine.spotlight.SpotlightIncludedProjectsValueSource
...
data class CCDiagnostic(
  ...
  data class Input(
    ...
    companion object {
      val SpotlightValueSource = Input(
        CUSTOM_SOURCE,
        SpotlightIncludedProjectsValueSource::class.java.simpleName,
      )
